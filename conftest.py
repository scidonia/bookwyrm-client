...
def pytest_configure(config):
    ...
    config.addinivalue_line("markers", "docs: mark test as documentation code block test")
...
def setup_docs_environment(request):
    ...
    cleanup_patterns = [
        "*pages*.json", "*raw.txt", "*mapping.json", "*phrases.jsonl",
        "*summary*.json", "*citations*.json", "*analysis*.json", "character_positions.json"
    ]
