...
@pytest.mark.asyncio
async def test_classify_live_api_comprehensive(async_client, sample_text_content, sample_json_content, sample_html_content):
    ...
    response5 = await async_client.classify(
        content=sample_json_content
    )
